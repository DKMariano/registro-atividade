...
<html lang="en">
  <head>
    ...
    <title>Registro de Atividade - Esqueci minha senha</title>
  </head>
  ...
  <body>
    ...
    <div class="login-page">
      <div class="login-area">
        <h3 class="login-title">Registro de Atividade</h3>
        ...
        <div class="register-area">
          Ainda não tem cadastro? <a href="{{route('login')}}">Fazer Login</a>
        </div>
      </div>
      <div class="terms">
